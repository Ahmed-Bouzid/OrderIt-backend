 ...
 * - Toutes les réservations: status != "completed" -> "completed" + isPresent = false
 */
...
async function run() {
	...
	console.log(`  Réservations à passer en "completed": ${resasToUpdate}`);
	...
	console.log(
		`  Réservations encore non "completed": ${resasRemaining} (doit être 0)`
	);
